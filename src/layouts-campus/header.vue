...
<template>
  <header class="header-container">
    ...
    <div class="banner campus-banner">
    ...
    <div class="recruitment-container">
      ...
      >
        <template #left>
          <img src="@/assets/images/logo.png" @click="handleNavClick({ name: '校园招聘', path: '/campus-recruitment/campus', isExternal: false })" alt="logo" class="logo">
        </template>
